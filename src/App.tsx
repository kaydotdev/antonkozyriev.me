    ...
    <div className="flex print:aspect-[1/1.4142] w-screen h-fit sm:flex-row flex-col">
      ...
      <div className="sm:grow bg-slate-100">
        <div className="flex flex-col p-6">
          ...
          <div className="flex pt-2 flex-row flex-wrap justify-evenly sm:justify-start sm:gap-x-2 mb-6 sm:mt-3">
            ...
            <SocialMediaButton text="github.com/antonAce" color="#333">
