    ...
    <div className="flex print:aspect-[1/1.4142] w-screen h-fit sm:flex-row flex-col">
      ...
      <div className="sm:grow bg-slate-100">
        <div className="flex flex-col p-6">
          ...
          <div className="flex pt-2 flex-row flex-wrap justify-evenly sm:justify-center justify-items-stretch sm:gap-x-2 sm:mt-3">
            <SocialMediaButton href="https://www.facebook.com/anton.kozyriev" text="facebook.com/anton.kozyriev" color="#1877f2">
            ...
            <SocialMediaButton href="https://github.com/antonAce" text="@antonAce" color="#333">
            ...
            <SocialMediaButton href="https://t.me/antonace" text="@antonace" color="#0088cc">
            ...
            <SocialMediaButton href="https://linkedin.com/in/anton-kozyriev-66b272166" text="linkedin.com/in/anton-kozyriev-66b272166" color="#0077b5">
            ...
            <SocialMediaButton href="https://www.instagram.com/tony.mnemonic" text="@tony.mnemonic" color="#c13584">
