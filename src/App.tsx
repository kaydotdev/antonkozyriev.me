      ...
      <div className="sm:grow bg-slate-100">
        <div className="flex flex-col p-6">
          ...
          <div className="flex pt-2 flex-row flex-wrap justify-evenly sm:justify-center justify-items-stretch sm:gap-x-2 sm:mt-3">
            <SocialMediaButton text="facebook.com/anton.kozyriev" color="#1877f2">
            ...
            <SocialMediaButton text="@antonAce" color="#333">
            ...
            <SocialMediaButton text="@antonace" color="#0088cc">
            ...
            <SocialMediaButton text="linkedin.com/in/anton-kozyriev-66b272166" color="#0077b5">
            ...
            <SocialMediaButton text="@tony.mnemonic" color="#c13584">
