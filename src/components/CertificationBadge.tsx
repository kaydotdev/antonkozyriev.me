            ...
            <div className="p-2">
                <div className="flex flex-row items-center">
                    ...
                    <div className="ml-2">
                        ...
                        <p className="text-secondary text-sm">{props.name}</p>
                    </div>
                </div>
                <div className="flex flex-row items-center mt-2">
                    ...
                    <p className="text-secondary text-sm sm:text-xs">{props.timestamp}</p>
                </div>
                <div className="flex flex-row items-center mt-1">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                    </svg>
                    <a className="block sm:hidden" href={props.href}><p className="text-secondary">View certificate</p></a>
                    <p className="hidden sm:block text-secondary text-xs tracking-tight break-all">{props.href}</p>
                </div>
            </div>
        </div>
    );
