...
function UkraineCharityWidget() {
    ...
    return (
        <div className="fixed bottom-3 right-3 rounded-md shadow-2xl ring-1 ring-slate-900/10" style={widgetStyle}>
            <div className="flex space-x-2 justify-center">
                <div className="bg-white shadow-lg mx-auto w-72 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block">
                    <div className=" bg-white flex justify-between items-center py-2 px-3 bg-clip-padding border-b border-slate-200 rounded-t-lg">
                        <p className="text-slate-800 tracking-tigher"><span className="font-extrabold">{invasionDays}</span> days of invasion</p>
                        <div className="flex items-center">
                            <button onClick={() => setHidden(true)} type="button" className="box-content w-4 h-4 ml-2 text-slate-800 border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-slate-800 hover:opacity-75 hover:no-underline">
                    ...
                    <div className="p-3 bg-white rounded-b-lg break-words text-slate-700 border-b border-slate-200">
                    ...
                    <div className="p-3 flex flex-row justify-evenly items-center gap-x-2">
                        ...
                        <a href="https://war.ukraine.ua/arm-ukraine-now" className="text-slate-800 hover:text-slate-900 transition duration-300 ease-in-out underline uppercase">Arm Ukraine</a>
                    </div>
                </div>
            </div>
        </div>
